...
제2조(정의)
① “몰”이란 주식회사 에이플러스엑스 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
경찰청 사이버안전국 (cyberbureau.police.go.kr / 국번없이 182)
		...
		btn_click.addEventListener("click", function(){
			if(ag_ck1.checked && ag_ck2.checked){
				location.href="submit.jsp";
			} else if(!(ag_ck2.checked)){
