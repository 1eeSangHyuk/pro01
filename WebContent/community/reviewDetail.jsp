...
%>
		 				<tr>
		 					<td colspan="4"></td>
							<td colspan="1">
								<a href="./reviewDetailUpdate.jsp?review_no=<%=review_no %>">리뷰 수정하기</a>
							</td>
							<td colspan="1">
								<a href="./reviewDetailDel.jsp?review_no=<%=review_no %>">리뷰 삭제하기</a>
							</td>
						</tr>
<%
 					}
%>
						<tr>
							<td colspan="6"><a href="<%=path %>/community/community.jsp#page2">뒤로가기</a></td>
						</tr>
<%
				}
				rs.close();
